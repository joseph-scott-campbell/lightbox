...
# So, e.g. slice_maker[14] gives a slice(1,None,4) object.
...
class Neopixel
    ...
    def set_pixel_line(self, pixel1, pixel2, rgb_w, how_bright=None)
        ...
        if pixel2 = pixel1
            self.set_pixel(slice_maker[pixel1pixel2 + 1], rgb_w, how_bright)
    ...
    def __setitem__(self, idx, rgb_w)
        ...
        npix[1521] = (255,0,0)     # - sets 16,17 .. 20 to red
        npix[21292] = (0,0,255)   # - sets 21,23,25,27 to blue
        npix[12] = (0,0,0)        # - sets all odd pixels to 'off'
    ...
    def colorHSV(self, hue, sat, val)
        ...
        httpsgithub.comadafruitAdafruit_NeoPixel so all the credits for that
        go directly to them (license httpsgithub.comadafruitAdafruit_NeoPixelblobmasterCOPYING)
